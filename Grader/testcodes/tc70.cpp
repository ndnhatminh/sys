...
void run() {
  ...
  std::cout << s12345678910.getParTreeStringPreOrder("l") << std::endl;
  std::cout << s12345678910.getParTreeStringPreOrder("lr") << std::endl;
  std::cout << s12345678910.getParTreeStringPreOrder("llll") << std::endl;
}