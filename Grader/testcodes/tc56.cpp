...
void run() {
  ...
  delete s12;
  delete s4;
  std::cout << s1234.getParTreeSize("lr") << std::endl;
  std::cout << s1234.getParTreeSize("rl") << std::endl;
  std::cout << s1234.getParTreeSize("ll") << std::endl;
  std::cout << s1234.getParTreeSize("rr") << std::endl;
}