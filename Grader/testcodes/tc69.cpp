...
void run() {
  ...
  std::cout << s1234567890.getParTreeStringPreOrder("llr") << std::endl;
  std::cout << s1234567890.getParTreeStringPreOrder("rlr") << std::endl;
  std::cout << s1234567890.getParTreeStringPreOrder("r") << std::endl;
}