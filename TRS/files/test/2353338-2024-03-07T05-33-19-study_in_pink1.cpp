...
int firstMeet(int& exp1, int& exp2, int e1) {
    ...
    if (e1 >= 0 && e1 <= 3) {
        ...
        int D = e1 * 3 + exp1 * 7;
        if (D % 2 == 0)
            exp1 += std::ceil(static_cast<double>(D) / 200);
        else
            exp1 -= std::floor(static_cast<double>(D) / 100);
    }
    else {
        if (e1 >= 4 && e1 <= 19)
            exp2 += std::ceil(static_cast<double>(e1) / 4.0 + 19);
        else if (e1 >= 20 && e1 <= 49)
            exp2 += std::ceil(static_cast<double>(e1) / 9.0 + 21);
        else if (e1 >= 50 && e1 <= 65)
            exp2 += std::ceil(static_cast<double>(e1) / 16.0 + 17);
        else if (e1 >= 66 && e1 <= 79) {
            exp2 += std::ceil(static_cast<double>(e1) / 4 + 19);
            if (exp2 > 200)
                exp2 += std::ceil(static_cast<double>(e1) / 9.0 + 21);
        }
        else if (e1 >= 80 && e1 <= 99) {
            exp2 += std::ceil(static_cast<double>(e1) / 4 + 19) +
                std::ceil(static_cast<double>(e1) / 9 + 21);
            if (exp2 > 400)
                exp2 += std::ceil(static_cast<double>(e1) / 16.0 + 17);
            exp2 = static_cast<int>(exp2 * 1.15);
        }
        exp1 -= e1;
        exp1 = std::max(0, exp1);
        exp2 = std::max(0, exp2);
        exp1 = std::min(600, exp1);
        exp2 = std::min(600, exp2);
    }
    return exp1 + exp2;
}
    ...
    else
    {
        ...
        while (m1 != 0) {
            ...
            case 1:
                ...
                else exp1 = ceil(float(exp1 * 1.13));
                m1 -= 120;
                break;
            case 2:
                if (exp1 < 300) {
                ...
                else exp1 = ceil(float(exp1 = exp1 * 0.9));
                m1 -= 120;
                limit(hp1, 0, 666);
                limit(m1, 0, 3000);
                break;
