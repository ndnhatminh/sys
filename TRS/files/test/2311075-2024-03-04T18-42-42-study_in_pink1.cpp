...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    while (flag && m1 < M1 / 2) {
        CLAMP_HP(HP1);
        if (HP1 < 200) {
            if ((m1 + 150 > M1) && aaa) break;
            HP1 = ceil(HP1 * 1.3);    CLAMP_HP(HP1);
            m1 += 150; if ((m1 > M1 / 2) && aaa) break;
        }
        else {
            if ((m1 + 70 > M1) && aaa) break;
            m1 += 70;
            HP1 = ceil(HP1 * 1.1);    CLAMP_HP(HP1);
            if ((m1 > M1 / 2) && aaa) break;
        }
        CLAMP_EXP(EXP1);
        if ((m1 + 200 > M1) && (EXP1 < 400) && aaa) break;
        else if ((m1 + 120 > M1) && aaa) break;
        m1 += (EXP1 < 400) ? 200 : 120;
        EXP1 = ceil(1.13 * EXP1); CLAMP_EXP(EXP1);

        if (m1 > M1 / 2 && aaa) break;
        if ((m1 + 100 > M1) && (EXP1 < 300) && aaa) break;
        else if ((m1 + 200 > M1) && aaa) break;
