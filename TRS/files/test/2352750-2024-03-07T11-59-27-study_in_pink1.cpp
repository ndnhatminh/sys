...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    //Trường hợp 2
        ...
        if(e1>=4 && e1<=19) exp2 =(exp2+(e1/4+19))+1; // thông tin 1
        if(e1>=20 && e1<=49) exp2 =(exp2+(e1/9+21))+1; // thông tin 2
        if(e1>=50 && e1<=65) exp2 =(exp2+(e1/16+17))+1; //thông tin 3
        //thông tin 4
        if(e1>=66 && e1<=79) {
            exp2 = (exp2+(e1/4.000 + 19))+1;
            if (exp2 > 200) {
                exp2 = (exp2+(e1/9 + 21))+1;
            }
        }
