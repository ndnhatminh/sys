...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    float p1;
    float a=sqrt(EXP1);
    float scpnho=floorf(a)*floorf(a);
    float scplon=ceilf(a)*ceilf(a);
    if(scplon-EXP1>EXP1-scpnho) p1=1.00;
    else if(scpnho==scplon) p1=1.00;
    else p1=(EXP1/scplon+80)/123;
    checkHp1(HP1);
    int m=ceilf(0.5*M1);
    if(M1==0){
        HP1=ceilf(0.83*HP1);
    ...
    float p2;
    float b=sqrt(EXP1);
    float scpnho2=floorf(b)*floorf(b);
    float scplon2=ceilf(b)*ceilf(b);
    if(scplon2-EXP1>EXP1-scpnho2) p2=1.0;
    else if(scplon2==scpnho2) p2=1.0;
    else p2=(EXP1/scplon2+80)/123;
