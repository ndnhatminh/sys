...
int firstMeet(int& exp1, int& exp2, int e1) {
    ...
    if (e1 >= 0 && e1 <= 3) {
        if (e1 == 0)
            exp2 = luiSoEXP(exp2 + 29 + 0.999);
        else if (e1 == 1)
            exp2 = luiSoEXP(exp2 + 45 + 0.999);
        else if (e1 == 2)
            exp2 = luiSoEXP(exp2 + 75 + 0.999);
        else if (e1 == 3)
            exp2 = luiSoEXP(exp2 + 29 + 45 + 75 + 0.999);

        int d = e1 * 3 + exp1 * 7;

        if (d % 2 == 0) {
            exp1 = luiSoEXP(exp1 + (d / 200) + 0.999);
        }
        else {
            exp1 = luiSoEXP(exp1 - (d / 100) + 0.999);
        }
    }
    else if (e1 >= 4 && e1 <= 99) {
        if (e1 >= 4 && e1 <= 19) {
            exp2 = luiSoEXP(exp2 + (e1 / 4 + 0.999) + 19 + 0.999);
        }
        else if (e1 >= 20 && e1 <= 49) {
            exp2 = luiSoEXP(exp2 + (e1 / 9 + 0.999) + 21 + 0.999);
        }
        else if (e1 >= 50 && e1 <= 65) {
            exp2 = luiSoEXP(exp2 + (e1 / 16 + 0.999) + 17 + 0.999);
        }
        else if (e1 >= 66 && e1 <= 79) {
            exp2 = luiSoEXP(exp2 + (e1 / 4 + 0.999) + 19 + 0.999);
            if (exp2 > 200) {
...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    while (P1 == 1.0 && P2 == 1.0 && P3 == 1.0) {
        ...
        //Con duong 2
        if (HP1 < 200) {
            HP1 = luiSoHP(HP1 + (0.3 * HP1) + 0.999);
            M1 = luiSoM(M1 - 150 + 0.999);
        }
        else {
            HP1 = luiSoHP(HP1 + (0.1 * HP1) + 0.999);
            M1 = luiSoM(M1 - 70 + 0.999);
        }

        if (EXP1 < 400) {
            M1 = luiSoM(M1 - 200 + 0.999);
            EXP1 = luiSoEXP(EXP1 * 1.13 + 0.999);
        }
        else {
            M1 = luiSoM(M1 - 120 + 0.999);
            EXP1 = luiSoEXP(EXP1 * 1.13 + 0.999);
        }

        if (EXP1 < 300) {
            M1 = luiSoM(M1 - 100 + 0.999);
            EXP1 = luiSoEXP(EXP1 * 0.9 + 0.999);
        }
        else {
            M1 = luiSoM(M1 - 120 + 0.999);
            EXP1 = luiSoEXP(EXP1 * 0.9 + 0.999);
        ...
        HP1 = luiSoHP(HP1 * 0.83 + 0.999);

        EXP1 = luiSoEXP(EXP1 * 1.17 + 0.999);
    ...
    if (P < 0.5) {
        HP1 = luiSoHP(0.85 * HP1 + 0.999);
        EXP1 = luiSoEXP(1.15 * EXP1 + 0.999);
    }
    else {
        HP1 = luiSoHP(0.9 * HP1 + 0.999);
        EXP1 = luiSoEXP(1.2 * EXP1 + 0.999);
    }
...
int chaseTaxi(int & HP1, int & EXP1, int & HP2, int & EXP2, int E3) {
    ...
    if (abs(taxiMaTran[a][b]) > giaTriLonNhat) {
        EXP1 = luiSoEXP(0.88 * EXP1 + 0.999);
        HP1 = luiSoHP(0.9 * HP1 + 0.99);
        EXP2 = luiSoEXP(0.88 * EXP2 + 0.999);
        HP2 = luiSoHP(0.9 * HP2);
        return taxiMaTran[a][b];
    }
    else {
        EXP1 = luiSoEXP(1.12 * EXP1 + 0.999);
        HP1 = luiSoHP(1.1 * HP1 + 0.99);
        EXP2 = luiSoEXP(1.12 * EXP2 + 0.999);
        HP2 = luiSoHP(1.1 * HP2);
...
int checkPassword(const char* s, const char* email) {
    ...
    bool chuaKyTuDacBiet = false;
    for (int i = 0; i < s_length; ++i) {
        if (kyTuDacBiet(s[i])) {
            chuaKyTuDacBiet = true;
        }
    }
    if (chuaKyTuDacBiet)
        return -5;
