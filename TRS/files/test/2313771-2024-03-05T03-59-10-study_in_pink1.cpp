...
int point_of_SW_position=find_max_arr_int(point1,p1);
...
if (size_s<=size_se)
{cout<<endl<<"se can contain or nearly contain s bcz length of se is longer than or equal the one of s"<<endl;}
else 
{
