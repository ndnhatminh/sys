...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    if (e1 >= 0 && e1 <= 3) {
        ...
        if (e1 >= 4 && e1 <= 19) {
            exp2 += ceilf(float(e1 / 4) + 0.999) + 19;
        }
        else if (e1 >= 20 && e1 <= 49) {
            exp2 += ceilf(float(e1 / 9) + 0.999) + 21;
        }
        else if (e1 >= 50 && e1 <= 65) {
            exp2 += ceilf(float(e1 / 16) + 0.999) + 17;
        }
        else if (e1 >= 66 && e1 <= 79) {
            exp2 += ceilf(float(e1 / 4) + 0.999) + 19;
            if ((int)exp2 > 200) {exp2 += ceilf(float(e1 / 9) + 0.999) + 21;}
        }
        else {
            exp2 += ceilf(float(e1 / 4) + 0.999) + 19;
            exp2 += ceilf(float(e1 / 9) + 0.999) + 21;
            if ((int)exp2 > 400) {
                exp2 += ceilf(float(e1 / 16) + 0.999) + 17;
                exp2 += ceilf(float(exp2 * 0.15) + 0.999); 
            }
        }
        exp1 -= e1; 
    }
...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    average = (P1 + P2 + P3) / 3;
    if (average < 0.50) {
        HP1 -= ceilf(float(HP1 * 0.15));
        EXP1 += (EXP1 * 0.15) + 0.999;
    }
    else {
        HP1 -= ceilf(float(HP1 * 0.10));
        EXP1 += (EXP1 * 0.20) + 0.999;
    }
...
int chaseTaxi(int & HP1, int & EXP1, int & HP2, int & EXP2, int E3) {
    ...
    if (abs(matrixTaxi[posSum][negSum]) > matrixSW[posSum][negSum]) {
        ...
        HP1 -= ceil(float(HP1 * 0.10));
        HP2 -= ceil(float(HP2 * 0.10));        
