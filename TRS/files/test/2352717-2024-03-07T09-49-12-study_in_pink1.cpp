...
int firstMeet(int & exp1, int & exp2, int E1) {
    if ( E1>=0 && E1<=3){
        ...
        if (D%2) {
            exp1 -=  ceil(D / 100.0);    checkEXP(exp1,exp2);
        } else {
            exp1 += ceil(D / 200.0);    checkEXP(exp1,exp2);
        }
        checkEXP(exp1,exp2);
    }
    else if (E1>=4 && E1 <=99)
    {
        exp1 -= E1;
        if (E1<=19) exp2 += ceil(E1/4.0)+ 19;  checkEXP(exp1, exp2);
        
        else if (E1<=49) exp2 += ceil(E1/9.0) + 21;  checkEXP(exp1, exp2);
        
        else if (E1<=65) exp2 += ceil(E1/16.0) + 17;  checkEXP(exp1, exp2);
        ...
        {  exp2+= ceil(E1/4.0) + 19;
            ...
            if (exp2>200) exp2 += ceil(E1/9.0) + 21; checkEXP(exp1,exp2); }
        
          else if(E1<=99)  { exp2 += ceil(E1/4.0) + 19;
