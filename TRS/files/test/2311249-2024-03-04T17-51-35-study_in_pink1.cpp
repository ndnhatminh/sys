...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    if (E2 >= 0 && E2 <= 99) {
        ...
        if (EXP1 >= soChinhPhuongGanNhat(EXP1)) {
            ...
            P1 = (static_cast<double>(EXP1) / soChinhPhuongGanNhat(EXP1) + 80) / 123;
        }
        //Con Duong 02
        if (E2 % 2 == 1) {
            do {
        ...
        if (EXP1 >= soChinhPhuongGanNhat(EXP1)) {
            ...
            P2 = (static_cast<double>(EXP1) / soChinhPhuongGanNhat(EXP1) + 80) / 123;
        }
        //Con duong 03
        int P[] = { 32 / 100, 47 / 100, 28 / 100, 79 / 100, 100 / 100, 50 / 100, 22 / 100, 83 / 100, 64 / 100, 11 / 100 };
        if (E2 / 10 == 0) {
            P3 = P[E2];
        }
        else {
        ...
        //Tong ket
        if (P1 == 100 / 100 && P2 == 100 / 100 && P3 == 100 / 10) {
