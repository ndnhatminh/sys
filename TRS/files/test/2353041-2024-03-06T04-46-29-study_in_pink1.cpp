...
//Task 3
//find the the position that Taxi meets Sherlock and Waston
ll findPoint(int n){
...
int findCorrectPassword(const char * arr_pwds[], int num_pwds) {
    ...
    for(int i = 0; i < num_pwds; i++){
        int total = 0;
        //find the frequency in the array
