...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) 
{
    ...
    if (E2%2)//when e2 odd
    {
        while (d <= M1)
        {
            ...
            if (EXP1 < 400) 
            {
                ...
                EXP1 = EXP1 + ceil(EXP1 * 0.13 - 1e-10);
                EXP1 = expup(EXP1);//update value of exp1
            }
            else 
            {
        ...
        EXP1 = EXP1 + ceil(EXP1 * 0.17 - 1e-10);
        EXP1 = expup(EXP1);//update value of exp1
    ...
    {
        EXP1 = ceil(EXP1 * 0.75 - 1e-10);
        EXP1 = expup(EXP1);//update value of exp1
    }
    else if (((P1 + P2 + P3)/3) < 0.5)
        {
            HP1 = ceil(HP1*0.85 - 1e-10);
            HP1 = hpup(HP1);//update value of hp1

            EXP1 = EXP1 + ceil(EXP1 * 0.15 - 1e-10);
            EXP1 = expup(EXP1);//update value of exp1
        }
        else
        {
