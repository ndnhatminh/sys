...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    if(E2>=0 && E2<10){
        ...
        int sum=(E2%10)+(E2/10), num=abs(sum-10);
        P3=P[num];
    }
    int averageP;
