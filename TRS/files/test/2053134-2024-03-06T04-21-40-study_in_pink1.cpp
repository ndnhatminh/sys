...
int traceLuggage(int &HP1, int &EXP1, int &M1, int E2)
{
    ...
    {
        P1 = 100.0 * (ceil((EXP1 * 1.0 / S)) + 80) * 1.0 / 123; // note
    }
    cout << "P1: " << P1 << " ";
    // street 2
    int used_m = 0;
    double half_m = ceil(M1 * 0.5);
    if ((E2 % 2) == 1)
    {
        while (used_m < half_m)
        {
    ...
    {
        P2 = 100.0 * (ceil((EXP1 * 1.0 / S2)) + 80) * 1.0 / 123; // note
    }
    cout << "P2: " << P2 << " ";
    // street 3
    (float)P3;
    ...
    else
    {
        ...
        if (P_avg < 50.0)
        {
            HP1 = ceil(HP1 * 1.0 * 0.85);
            EXP1 = ceil(EXP1 * 1.0 * 1.15);
        }
        else if (P_avg >= 50)
        {
            HP1 = ceil(HP1 * 1.0 * 0.9);
            EXP1 = ceil(EXP1 * 1.0 * 1.2);
        }
    }
...
int chaseTaxi(int &HP1, int &EXP1, int &HP2, int &EXP2, int E3)
{
    ...
    // cout << "sherlock=" << Sherlock << "; taxi=" << Taxi << '\n';
