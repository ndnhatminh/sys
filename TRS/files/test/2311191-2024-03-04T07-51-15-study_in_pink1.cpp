...
{
    double array[] = {32.0, 47.0, 28.0, 79.0, 100.0, 50.0, 22.0, 83.0, 64.0, 11.0};
    if (E2<10)
    {
    return array[E2];
    }
...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    double P;
    CheckFunction2(HP1, EXP1, M1);
    P=(firstPath(checknearestSquare(EXP1),EXP1)+secondPath(M1,HP1,EXP1,E2)+thirdPath(E2)/100.0)/3;
    if (P==1)
    {
        EXP1=ceil(EXP1*0.75);
        CheckFunction2(HP1, EXP1, M1);
