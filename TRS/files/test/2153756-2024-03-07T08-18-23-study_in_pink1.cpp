...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    if (E2 >= 0 && E2 <= 99) {
        ...
        if (E2 % 2 == 1) {
        ...
        else {// e2 = 78, hp1= 666 , exp1 = 345, m1= 299
            if (M1 > 0) {
                if (HP1 < 200) {
                    HP1 = lam_tron(HP1 * 1.3);
                    M1 -= 150;
            ...
            if (M1 > 0) {
                ...
                EXP1 = lam_tron(EXP1 * 0.9);//481
                limitExp(EXP1);
            } 
            EXP1 = lam_tron(EXP1 * 1.17);//563
            HP1 = lam_tron(HP1 * 0.83);//263
        }
        limitHp(HP1);
        limitExp(EXP1);
        limitM(M1);
