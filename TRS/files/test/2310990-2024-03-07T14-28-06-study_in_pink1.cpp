...
int findCorrectPassword(const char* arr_pwds[], int num_pwds) {
    // TODO: Complete this function
    int k = 0;
    int a[200]; a[num_pwds] = '\0'; int b[200]; b[num_pwds] = '\0';
    ...
    for (int i = 0; i < num_pwds; i++)
    {
        ...
        a[i] = k;
        b[i] = strlen(arr_pwds[i]);// mang chieu dai
        k = 0;
    }
    int max = 0; int dai = 0; int h = 0; int vitri = -1;
    for (int i = 0; i < num_pwds; i++)
    {
        for (int j = 0; j < i; j++)
        {
            if (arr_pwds[i] == arr_pwds[j]) h = 1;
        }
        if (h == 0)
        {
            if ((a[i] > max) || ((a[i] == max) && (b[i] > dai)))
            {
                vitri = i;
                max = a[i];
                dai = b[i];
    ...
    //int a = 0; int  k = 1, d;
    //int arr1[300], arr2[300], arr3[300]; int check = 1;
    //for (int i = 0; i < num_pwds; i++)
    //{        
    //    // ktra xem a[i] co xuat hien truoc do khong
    //    int j = 0;
    //    for (j = 0; j < i; j++)
    //    {
    //        if (arr_pwds[i] == arr_pwds[j])
    ...
    //    {
    //       
    //        for (int h = i+1; h < num_pwds; h++)
    //        {
    //            if (arr_pwds[i] == arr_pwds[h])
    //                k = k + 1;
    //        }
    //        a = a + 1;
    //        arr1[a - 1] = k;// mang so lan xuat hien
    //        arr2[a - 1] = i;
    //        //mang vi tri tuong ung
    //    }
    //    check = 1;
    //    k = 1;
    //}
    //int arr4[300];
    //arr1[a] = '\0'; arr2[a] = '\0'; int max = arr1[0];
    //// tim so lan xuat hien nhieu nhat
    //for (int i = 0; i < a; i++)
    //{
    //    if (arr1[i] > max) max = arr1[i];
    //}
    //// lap mang do dai chuoi cua nhung phan tu xuat hien nhieu nhat
    //int b = 0;
    //for (int k = 0; k < a; k++)
    //{
    //    if (arr1[k] == max)
    ...
    //        b = b + 1;
    //        // mang do dai
    //        arr3[b - 1] = strlen(arr_pwds[arr2[k]]);
    //        //mang vi tri chi so phan tu tuong ung mang do dai
    //        arr4[b - 1] = arr2[k];
    //    }
    //}
    //arr3[b] = '\0'; arr4[b] = '\0';
    ...
    //for (int i = 0; i < b; i++)
    //{
    //    if (arr3[i] > dai) dai = arr3[i];
    //}
    //// ktra xem phan tu nao la max, roi in ra vi tri cua no
    //int c;
    //for (int i = 0; i < b; i++)
    //{
    //    if (arr3[i] == dai)
