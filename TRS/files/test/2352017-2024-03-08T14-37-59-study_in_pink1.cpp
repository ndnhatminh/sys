...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    else exp1 -= ceil(float(D/100)) ;
    }
    else if (e1>= 4 && e1 <= 99)
    {
        exp1 -= e1;
        if (e1 >=4 && e1 <= 19) exp2 += ceil(float(e1/4.0 + 19));
        else if (e1 >=20 && e1 <= 49) exp2 += ceil(float(e1/9.0 + 21));
        else if (e1 >= 50 && e1 <= 65) exp2 += ceil(float(e1/16.0+ 17));
        else if (e1 >= 66 && e1 <= 79)
        {
            exp2 +=ceil(float(e1/4.0 + 19));
            if (exp2 >400) exp2 += ceil(float(e1/9.0 + 21));
        }
        else if (e1 >= 80 && e1 <= 99)
        {
            exp2 += ceil(float(e1/4.0 + 19));
