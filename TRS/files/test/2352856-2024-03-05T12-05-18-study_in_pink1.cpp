...
// tinh toan gia tri cua Taxi - lap bang ma tran 
int diemso2nguoi = 0; 
int greater = 0;
int lessthan = 0;
for (int i = 0; i < 10; i++)
{
    for ( int j = 0; j < 10; j++)
    {
        ...
        if (arrayTaxi[i][j] > (2 * E3)) greater ++;
        if (arrayTaxi[i][j] < (- E3)) lessthan ++;
...
while ( greater > 9)
{
    greater = (greater  / 10) + (greater %10);
}

while (lessthan > 9)
{
    lessthan = (lessthan / 10) + (lessthan % 10);
}

const int i_point = greater;
const int j_point = lessthan; 
int diemsoTaxi = arrayTaxi[i_point][j_point];
int i_cheotraiphiaduoi = greater;
int j_cheotraiphiaduoi = lessthan;
//duong cheo phai check 
for (int i = 0; i < 10; i++)
{
    for ( int j = 0; j < 10; j++)
    {
        if ( (i + j) == (i_point + j_point) ) 
        {
            if ( arrayTaxi[i][j] > diemso2nguoi) diemso2nguoi = arrayTaxi[i][j];
            else continue;
        }
    }
}  

// duong cheo trai phia tren check 
while ( greater >= 0)
{
    if ( (arrayTaxi[greater][lessthan])  > diemso2nguoi  ) diemso2nguoi = (arrayTaxi[greater][lessthan]);
    --greater;
    --lessthan;
}
while ( j_cheotraiphiaduoi <= 9)
{
    if ( (arrayTaxi[i_cheotraiphiaduoi][j_cheotraiphiaduoi]) > diemso2nguoi ) diemso2nguoi = (arrayTaxi[i_cheotraiphiaduoi][j_cheotraiphiaduoi]);
    ++ i_cheotraiphiaduoi;
    ++ j_cheotraiphiaduoi;
}

if (abs(diemsoTaxi) > diemso2nguoi)//cannot catch up the taxi
    {
