...
else if (e1 == 1)
{
    ...
    {
        exp2 = exp2 + round(e1 / 4.0 + 19);
    }
    else if (e1 <= 49)
    {
        exp2 = exp2 + round(e1 / 9.0 + 21);
    }
    else if (e1 <= 65)
    {
        exp2 = exp2 + round(e1 / 16.0 + 17);
    }
    else if (e1 <= 79)
    {
        exp2 = exp2 + round(e1 / 4.0 + 19);
    ...
    {
        exp2 = exp2 + round(e1 / 4.0 + 19 + e1 / 9.0 + 21);
        if (exp2 > 600) { exp2 = 600; }
        if (exp2 < 0) { exp2 = 0; }
        if (exp2 > 400)
        {
