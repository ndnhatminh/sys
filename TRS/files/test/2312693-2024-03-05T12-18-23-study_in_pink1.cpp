...
{int n=1000; for(int a =0; a<26; ++a){
    if (abs(a*a-EXP)<=n) {S = sqrt(a);n=abs(sqrt(a)-EXP);};};
if (EXP>=S) P=1;
else P = ((EXP/S)+80)/123;
return P;}
...
checkM(M1);
checkE(E2);
float P1,P2,P3[] = {32,47,28,79,100,50,22,83,64,11}, pba;
int S1=0,M=M1/2,S2=0,i;

findnear(S1,P1,EXP1);
//tims2//
if (E2%2==1) {while (M<=M1){
if (HP1<200){M1=M1-150;
HP1=HP1*1.30 +tl;}
...
checkM(M1);checkEXP(EXP1);
findnear(S2,P2,EXP1);
//tim pba//
if (E2>9) {i = E2/10 + E2%10;pba =P3[int(i%10)]/100.0;}
else pba = P3[E2]/100.0;

if (P1==1 and P2==1 and pba==1)
EXP1= EXP1*0.75 +tl;
else if (((P1+P2+pba)/3.0)>=(0.5))
{HP1=HP1*0.90 +tl;
EXP1=EXP1*1.20 +tl;}
else{HP1=HP1*0.85 +tl;
EXP1=EXP1*1.15 +tl;};
