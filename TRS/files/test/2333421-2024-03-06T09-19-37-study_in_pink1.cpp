...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    S2 = can22 * can22;
    if (EXP1 >= S2) P2 = 100;
    else P2 = round(((EXP1 / (float)S2 + 80) / (float)123)+0.5 * 100);
//con duong 3
    int i;
    ...
    if (P3== 100 && P1 == 100 && P2== 100) EXP1 = ceil(EXP1-EXP1* 0.25);
        ...
        int sum = (P1 + P2 + P3) / 3;
        if (sum < 50) {
            HP1 = round(HP1 - 0.15 * HP1+0.5);
            EXP1 = ceil(EXP1 - EXP1 * 0.15);
        }
        else {
            HP1 = roundl((HP1 * 0.9) + 1);
