...
void buyFood(int &HP1, int &EXP1, int &M1, int E3)
{
...
void travel(int &HP1, int &EXP1, int &M1, int E3)
{
...
void metHomeless(int &HP1, int &EXP1, int &M1, int E3)
{
...
int traceLuggage(int &HP1, int &EXP1, int &M1, int E3)
{
    ...
    if (M1 > 0)
    {
        if (E3 % 2)
        {
            ...
            {
                buyFood(HP1, EXP1, M1, E3);

                if (M1 >= startMoney * 0.5)
                    travel(HP1, EXP1, M1, E3);

                if (M1 >= startMoney * 0.5)
                    metHomeless(HP1, EXP1, M1, E3);
            }
        }
        else
        {
...
int checkPassword(const char *s, const char *email)
{
    ...
    int i = 0, specialChar = 0, repeatCharCount = 0, repeatIndex = 0;
    char prevChar = '\0';
