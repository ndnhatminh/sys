...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    //trường hợp 1
        ...
        int d= 3*e1 + exp1*7;
        if (d % 2 == 0) {
            exp1 =round(float((exp1+ d/200)));
        }
        else {
            exp1 =round(float(exp1-d/100));
        }
    }
    //Trường hợp 2
    else {
        if(e1>=4 && e1<=19) exp2 =round(float(exp2+(e1/4+19))); // thông tin 1
        if(e1>=20 && e1<=49) exp2 =round(float(exp2+(e1/9+21))); // thông tin 2
        if(e1>=50 && e1<=65) exp2 =round(float(exp2+(e1/16+17))); //thông tin 3
        //thông tin 4
        if(e1>=66 && e1<=79) {
            exp2 = round(float(exp2+(e1/4.000 + 19)));
            if (exp2 > 200) {
                exp2 = round(float(exp2+(e1/9 + 21)));
            }
        }
        //thông tin 5
        if(e1 >= 80 && e1<=99) {
            exp2 = round(float(exp2 + (e1/4+19) + (e1/9+21)));
            if (exp2 > 400) {
                exp2 =round(float(exp2+ (e1/16 + 17)));
            }
