...
do{
	...
	//neu e2 chan ma het tien thi thoat
	if(E2%2==0){
		if(m1==0){
			break;
		}
	...
	int a3;//sau khi cong a1 va a2 ma ra 2 chu so
	...
	if(P1==1 && P2==1 && P3==1){
		...
		if(P<0.5){
			...
			hp1*=0.7483;//ban dau 0.9
			hp1=ceil(hp1);
			exp1*=1.4084;//ban dau 1.2
			exp1=ceil(exp1);
			if(exp1>600){
				exp1=600;
			}
