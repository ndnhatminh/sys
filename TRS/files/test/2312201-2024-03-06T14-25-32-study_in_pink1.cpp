...
int firstMeet(int& EXP1, int& EXP2, int E1) {
    ...
    int D = E1 * 3 + EXP1 * 7; float o = D / 200;float y = D / 100;
    if (E1 >= 0 && E1 < 4) {
        if (D % 2 == 0) { EXP1 = ceil(EXP1 + o);rsvl(EXP1, 0, 600); }
        else { EXP1 = ceil(EXP1 - y);rsvl(EXP1, 0, 600); };
    }
    //2.
    if (E1 >= 4 && E1 <= 19) { EXP2 = EXP2 + ceil(E1  / 4) + 19;rsvl(EXP2, 0, 600); }
    else if ((E1 >= 20) && (E1 <= 49)) {
        EXP2 = EXP2 + ceil(E1  / 9) + 21;rsvl(EXP2, 0, 600);
    }
    else if (E1 >= 50 && E1 <= 65) {
        EXP2 = EXP2 + ceil(E1  / 16) + 17;rsvl(EXP2, 0, 600);
    }
    else if (E1 >= 66 && E1 <= 79) {
        EXP2 = EXP2 + ceil(E1  / 4) + 19;rsvl(EXP2, 0, 600);
        if (EXP2 > 200) {
            EXP2 = EXP2 + ceil(E1  / 9) + 21;rsvl(EXP2, 0, 600);
        }
        else EXP2 = ceil(EXP2);
        ...
        EXP2 = EXP2 + ceil(E1 / 9) + 40 + ceil(E1  / 4);rsvl(EXP2, 0, 600);
        if (EXP2 > 400) {
            EXP2 = EXP2 + ceil(E1  / 16) + 17;rsvl(EXP2, 0, 600);EXP2 = ceil(EXP2 * 1.15);rsvl(EXP2, 0, 600);
        }
        else EXP2 = ceil(EXP2);
    }
