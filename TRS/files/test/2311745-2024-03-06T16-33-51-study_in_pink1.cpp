...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    if (E2 < 0 || E2 > 99) return -99;
        ...
        if (E2 >= 0 && E2 <= 9) P3 = arrP3[E2] / 100.0;
        else {
            if (E2 >= 10 && E2 <= 99) {
                i = E2 / 10 + E2 % 10;
            }
            if (i >= 0 && i <= 9) P3 = arrP3[i] / 100.0;
            else if (i >= 10 && i <= 99) {
                j = i % 10;
                P3 = arrP3[j] / 100.0;
            }
        ...
        if (P1 + P2 + P3 == 3.0) EXP1 = ceil(EXP1 - EXP1*0.25);
        else {
            if ((P1 + P2 + P3) / 3 < 0.5) {
...
int checkPassword(const char * s, const char * email) {
    ...
    else if (strS.find(se) != string::npos) return -(300 + strS.find(se));
