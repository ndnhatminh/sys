...
int traceLuggage(int &HP1, int &EXP1, int &M1, int E2) {
    ...
    if(!isEven(E2)) {
        ...
        while(N <= M1 / 2) {
            if(HP1 < 200) {
                x = ceil(HP1 * 130 / 100 + 0.49);
                HP1 = x;
                N += 150;
            } else {
                x = ceil(HP1 * 110 / 100 + 0.49);
                HP1 = x;
                N += 70;
            }
    ...
    x = ceil(HP1 * 83 / 100 + 0.49);
    HP1 = x;
    x = ceil(EXP1 * 117 / 100 + 0.49);
    EXP1 = x;
    ...
    int O;
    O = ceil((P1 + P2 + P3) / 3 + 0.49);
    if(O == 100) {
        x = ceil(EXP1 * 75 / 100 + 0.49);
        EXP1 = x;
    } else if(O < 50) {
        x = ceil(HP1 * 85 / 100 + 0.49);
        HP1 = x;
        x = ceil(EXP1 * 115 / 100 + 0.49);
        EXP1 = x;
    } else {
        x = ceil(HP1 * 90 / 100 + 0.49);
        HP1 = x;
        x = ceil(EXP1 * 120 / 100 + 0.49);
        EXP1 = x;
    }
