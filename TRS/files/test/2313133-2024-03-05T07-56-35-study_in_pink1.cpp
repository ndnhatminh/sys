...
int chaseTaxi(int & HP1, int & EXP1, int & HP2, int & EXP2, int E3) {
    ...
    ////////////CHECK/////////////
    //cout << "meet: " << map[meetr][meetc] << endl;
    //cout << "meetr, meetc: " << meetr << ", " << meetc << endl;
    ////////////////////////////////
    ...
    for(i = 1; (meetr + i < 10) && (meetc + i < 10); i++) {
        ...
        //SherPoint = getMax(map[meetr][meetc], map[meetr + i][meetc - i]);
        //SherPoint = getMax(map[meetr][meetc], map[meetr - i][meetc + i]);
        //SherPoint = getMax(map[meetr][meetc], map[meetr - i][meetc - i]);
    }
...
int checkPassword(const char * s, const char * email) {
    ...
    int sci;                                                                // has 2 continuous same char?
...
int findCorrectPassword(const char * arr_pwds[], int num_pwds) {
    ...
    for (i = 0;i < num_pwds; i++) {
        ...
        if (pwds_count > pwds_maxCount) {
            ...
            //cout << strlen(arr_pwds[i]) << " // " << pwds_current << endl;
