...
int limtSet(double num, const char* mod) {
    ...
    if ((strcmp(mod, "exp") == 0) && (num1 > 600)) {
        num1 = 600;
    }
    else if ((strcmp(mod, "m") == 0) && (num1 > 3000)) {
        num1 = 3000;
    }
    else if ((strcmp(mod, "hp") == 0) && (num1 > 666)) {
        num1 = 666;
    }
    if (num1 < 0) {
        num1 = 0;
...
int square_number(int number3) {
    int s = sqrt(number3);
    if (abs(s*s - number3) < abs((s+1)*(s+1) - number3)) {
        return s*s;
    }
    else {
        return ((s + 1)*(s + 1));
