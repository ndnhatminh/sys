...
int chaseTaxi(int& HP1, int& EXP1, int& HP2, int& EXP2, int E3) {
    ...
    if ((E3 < 0) || (E3 > 99)) {
        ...
        if (abs(Sherlock_Waston[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)]) < abs(taxi[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)])) {
            EXP1 = (int)((float)EXP1 - 0.12 * EXP1 + 0.99999);
            EXP2 = (int)((float)EXP2 - 0.12 * EXP2 + 0.99999);
            HP1 = (int)((float)HP1 - 0, 1 * HP1 + 0.99999);
            HP2 = (int)((float)HP2 - 0, 1 * HP2 + 0.99999);
            result = taxi[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)];
        }
        else {
            EXP1 = (int)((float)EXP1 + 0.12 * EXP1 + 0.99999);
            EXP2 = (int)((float)EXP1 + 0.12 * EXP2 + 0.99999);
            HP1 = (int)((float)HP1 + 0, 1 * HP1 + 0.99999);
            HP2 = (int)((float)HP2 + 0, 1 * HP2 + 0.99999);
            result = Sherlock_Waston[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)];
        }
    }
    check_limit(HP1, 0, 666);
    check_limit(EXP1, 0, 600);
