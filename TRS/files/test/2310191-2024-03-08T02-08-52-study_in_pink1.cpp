...
int firstMeet(int& exp1, int& exp2, int e1) {
    ...
    if ((e1 >= 4) && (e1 <= 19)) { exp2 = ceil(exp2 + ((e1 / 4.0) + 19)); exp1 = exp1 - e1; check_exp(exp1); check_exp(exp2); }
    else if ((e1 >= 20) && (e1 <= 49)) {
        exp2 = ceil(exp2 + ((e1 / 9.0) + 21)); exp1 = exp1 - e1; check_exp(exp1); check_exp(exp2);
    }
    else if ((e1 >= 50) && (e1 <= 65)) {
        exp2 = ceil(exp2 + ((e1 / 16.0) + 17)); exp1 = exp1 - e1; check_exp(exp1); check_exp(exp2);
    }
     else if ((e1 >= 66) && (e1 <= 79)) {
    ...
    int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
        ...
        if (E2 % 2 != 0) {
            ...
            while (M1 > 0) {
                if (HP1 < 200) {
                    HP1 = HP1 * 1.3; ceil(HP1); M1 -= 150; check_hp(HP1);
