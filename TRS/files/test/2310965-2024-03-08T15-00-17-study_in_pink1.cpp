...
int traceLuggage(int &HP1, int &EXP1, int &M1, int E2)
{
    ...
    HP1 = ceilf(HP1 * 83.0 / 100.0);
    EXP1 = ceilf(EXP1 * 117.0 / 100.0);
    checkHP(HP1);
    checkEXP(EXP1);
    checkM(M1);
...
int chaseTaxi(int &HP1, int &EXP1, int &HP2, int &EXP2, int E3)
{
    ...
    {
        EXP1 = ceilf(EXP1 * 88.0 / 100.0);
        HP1 = ceilf(HP1 * 9.0 / 10.0);
        EXP2 = ceilf(EXP2 * 88.0 / 100.0);
        HP2 = ceilf(HP2 * 9.0 / 10.0);
    }
    else
    {
        EXP1 = ceilf(EXP1 * 112.0 / 100.0);
        HP1 = ceilf(HP1 * 11.0 / 10.0);
        EXP2 = ceilf(EXP2 * 112.0 / 100.0);
        HP2 = ceilf(HP2 * 11.0 / 10.0);
    }
    checkHP(HP1);
    checkHP(HP2);
    checkEXP(EXP1);
