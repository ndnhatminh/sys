...
//Tìm số chính phương S gần nhất với EXP1
    sqrt_EXP1 = sqrt(EXP1);
    lower_cp = sqrt_EXP1 * sqrt_EXP1;
    higher_cp = (sqrt_EXP1 + 1) * (sqrt_EXP1 + 1);
...
//Tổng kết
    P = (P1 + P2 + P3) / 3;
        ...
        else if (P == 1) { //SH đã nhầm lẫn gì đó
        EXP1_TEST = EXP1;
        EXP1_TEST *=0.75;
        EXP1 = lamtronAndCheck(EXP1_TEST,0,600);
    }
...
int chaseTaxi(int& HP1, int& EXP1, int& HP2, int& EXP2, int E3) {
    ...
    EXP2 = lamtronAndCheck(EXP2_TEST, 0, 600);
    HP1 = lamtronAndCheck(HP1_TEST, 0, 666);
    HP2 = lamtronAndCheck(HP2_TEST, 0, 666);
