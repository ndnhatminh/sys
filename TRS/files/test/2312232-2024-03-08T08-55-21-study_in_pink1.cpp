...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    if(E2<0 || E2>99){
        ...
        M1 = limit(M1,3000);
        int m = M1;
        double p1 = 1, p2 = 1, p3 = 1, prob;
        //Road 1
        p1 = probability(EXP1);
        //Road 2
        if(E2 % 2 == 1){
            for(int e=1;e <=3 && M1 > 0 && M1 >= 0.5*m;e++){
                //An uong
                if(e % 3 == 1){
                    if(HP1 < 200){
                        M1 -= 150;
                        HP1 += ceil((double)30*HP1/100);
                    }
                    else{
                        M1 -= 70;
