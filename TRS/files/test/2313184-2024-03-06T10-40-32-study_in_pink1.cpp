...
int firstMeet(int & EXP1, int & EXP2, int E1) {
   ...
   if (E1 >=0 && E1 <=3){
    ...
    if (E1 >=4 && E1 <=99){
    if (E1 >=4 && E1 <=19) EXP2 = ceil(EXP2 + E1/4.00 + 19.0 ); 
    ...
    if (E1 >=80 && E1 <=99){
    EXP2 = ceil(EXP2 + E1/4.0 + 19.0 + E1/9.0 + 21.0 +0.0 );
    if (EXP2 >400) { EXP2 = ceil(EXP2 + E1/16.0 + 17.0 );
    EXP2 = ceil(EXP2 * 1.15  );
    }
    }   
    EXP1 = EXP1-E1;
...
if (E2 % 2==1){
    ...
    for (int h =1; h<10;h++){
         if (HP1 <200){
        HP1 = ceil(HP1*1.3 +0.0
);hp1(HP1);
        M1= M1 -150;
    }
    else {
        HP1 = ceil(HP1*1.1 +0.0
);hp1(HP1);
        M1= M1 -70;
    }
    if (M1 <og) break;
    ...
    HP1 = ceil(HP1*0.83 +0.0);
    EXP1=ceil(EXP1*1.17 +0.0);
}
//E2 chan
else if (E2 % 2==0){
    for (int h =1; h<2;h++){
...
if (p1==p2 && p2==p3 && p3==1.00) {EXP1=ceil(EXP1*0.75 + 0.);
    HP1 = ceil(HP1*0.90 +0.0
);}
else {if (avg<0.50){
     HP1 = ceil(HP1*0.85 +0.0
);
    EXP1=ceil(EXP1*1.15 +0.0);
}
else if (avg>=0.50){
     HP1 = ceil(HP1*0.90 + 0.0
);
    EXP1=ceil(EXP1*1.20 +0.0);
}
}
hp1(HP1);
exp1(EXP1);
