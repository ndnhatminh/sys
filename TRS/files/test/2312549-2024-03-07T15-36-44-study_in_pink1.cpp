...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E3) {
    ...
    if (E3 % 2 == 0) {
        float P1 = xacsuatconduong1(EXP1);//conduong1
        //conduong2
...
int chaseTaxi(int& HP1, int& EXP1, int& HP2, int& EXP2, int E3) {
    ...
    //===============================//
        ...
        if (abs(scoretaxi) > abs(scoreSW)) {
            EXP1 = round_value((float)EXP1 * 0.88);
            EXP2 = round_value((float)EXP2 * 0.88);
            HP1 = round_value((float)HP1 * 0.9);
            HP2 = round_value((float)HP2 * 0.9);
            EXP1 = checkEXP(EXP1);
            EXP2 = checkEXP(EXP2);
            HP1 = checkHP(HP1);
            HP2 = checkHP(HP2);
            ...
            EXP1 = round_value((float)EXP1 * 1.12);
            EXP2 = round_value((float)EXP2 * 1.12);
            HP1 = round_value((float)HP1 * 1.1);
            HP2 = round_value((float)HP2 * 1.1);
            EXP1 = checkEXP(EXP1);
            EXP2 = checkEXP(EXP2);
            HP1 = checkHP(HP1);
            HP2 = checkHP(HP2);
