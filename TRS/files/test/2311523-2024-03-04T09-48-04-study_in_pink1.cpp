...
//Con đường 2
    // Nếu E2 là số lẻ, lặp lại các sự kiện cho đến khi tiền cần chi lớn hơn 50% số tiền ban đầu hoặc thực hiện hết 3 hành động
        int moneySpent = 0;
        double HP1_TEST = HP1;
        if (E2 % 2 == 1) {
            while (moneySpent <= 0.5 * M1) {
