...
void su_kien_2(int& EXP1, int& M1, int& money) {
    ...
    EXP1 = (int)((float)EXP1 + 0.13 * EXP1 + 0.99999);
}
//su kien 3
void su_kien_3(int& EXP1, int& M1, int& money) {
    ...
    EXP1 = (int)((float)EXP1 - 0.1 * EXP1 + 0.99999);
}
// Task 2
...
HP1 = (int)((float)HP1 * 0.83 + 0.99999);
EXP1 = (int)((float)EXP1 + 0.17 * EXP1 + 0.99999);
check_limit(HP1, 0, 666);
check_limit(EXP1, 0, 600);
check_limit(M1, 0, 3000);
...
if (P == 100) {
    EXP1 = (int)((float)EXP1 - 0.25 * EXP1 + 0.99999);
}
else if (P != 100) {
    if (P < 50) {
        HP1 = (int)((float)HP1 * 0.85 + 0.99999);
        EXP1 = (int)((float)EXP1 + 0.15 * EXP1 + 0.99999);
    }
    else {
        HP1 = (int)((float)HP1 * 0.9 + 0.99999);
        EXP1 = (int)((float)EXP1 + 0.20 * EXP1 + 0.99999);
    }
}
check_limit(HP1, 0, 666);
check_limit(EXP1, 0, 600);
...
int chaseTaxi(int& HP1, int& EXP1, int& HP2, int& EXP2, int E3) {
    ...
    if ((E3 < 0) || (E3 > 99)) {
        ...
        for (int j = 0; j < 10; j++) {
            for (int i = 0; i < 10; i++) {
                Sherlock_Waston[i][j] = max_duong_cheo(taxi, i, j, E3);
            }
        }
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
        ...
        if (abs(Sherlock_Waston[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)]) < abs(taxi[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)])) {
            EXP1 = (int)ceil((float)EXP1 * 0.88);
            EXP2 = (int)ceil((float)EXP2 * 0.88);
            HP1 = (int)ceil((float)HP1 * 0.9);
            HP2 = (int)ceil((float)HP2 * 0.9);
            check_limit(HP1, 0, 666);
            check_limit(EXP1, 0, 600);
            check_limit(HP2, 0, 666);
            check_limit(EXP2, 0, 600);
            ...
            EXP1 = (int)ceil((float)EXP1 * 1.12);
            EXP2 = (int)ceil((float)EXP2 * 1.12);
            HP1 = (int)ceil((float)HP1 * 1.1);
            HP2 = (int)ceil((float)HP2 * 1.1);
            check_limit(HP1, 0, 666);
            check_limit(EXP1, 0, 600);
            check_limit(HP2, 0, 666);
            check_limit(EXP2, 0, 600);
            return Sherlock_Waston[toa_do_gap_nhau(count1)][toa_do_gap_nhau(count2)];
        }
    }
}
//check ky tu and so
