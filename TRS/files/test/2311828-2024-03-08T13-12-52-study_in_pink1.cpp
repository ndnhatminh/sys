...
int firstMeet(int& exp1, int& exp2, int e1) {
    ...
    if (e1 >= 0 && e1 <= 3) {
        if (e1 == 0)
            exp2 = luiSoEXP(exp2 + 29);
        else if (e1 == 1)
            exp2 = luiSoEXP(exp2 + 45);
        else if (e1 == 2)
            exp2 = luiSoEXP(exp2 + 75);
        else if (e1 == 3)
            exp2 = luiSoEXP(exp2 + 29 + 45 + 75);

        int d = e1 * 3 + exp1 * 7;

        if (d % 2 == 0) {
            exp1 = luiSoEXP(ceil(exp1 + (d * 1.0 / 200.0)));
        }
        else {
            exp1 = luiSoEXP(ceil(exp1 - (d * 1.0 / 100.0)));
        }
    }
    else if (e1 >= 4 && e1 <= 99) {
        if (e1 >= 4 && e1 <= 19) {
            exp2 = luiSoEXP(ceil(exp2 + (e1 * 1.0) / 4.0 + 19));
        }
        else if (e1 >= 20 && e1 <= 49) {
            exp2 = luiSoEXP(ceil(exp2 + (e1 * 1.0) / 9.0 + 21));
        }
        else if (e1 >= 50 && e1 <= 65) {
            exp2 = luiSoEXP(ceil(exp2 + (e1 * 1.0) / 16.0 + 17));
        }
        else if (e1 >= 66 && e1 <= 79) {
            exp2 = luiSoEXP(ceil(exp2 + (e1 * 1.0) / 4.0 + 19));
            if (exp2 > 200) {
