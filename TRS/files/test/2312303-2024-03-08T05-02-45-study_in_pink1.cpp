...
int firstMeet(int& exp1, int& exp2, int e1) {
    ...
    {
        exp02 = u / 4 + 19 + e1 / 9 + 21 + exp02 + 0.5;
        exp2 = round(exp02);
        ...
        if (exp02 > 400)
        {
            exp02 = u / 16 + 17 + exp02 + exp02 * 3 / 20 + 0.5;
            exp02 = round(exp02);
...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
        ...
        else
        {
            ...
            tongP = round(tongP * 100);
            if (tongP < 50)
            {
                hp01 = 0.85 * hp01 + 0.5;
                hp01 = round(hp01);

                exp01 = 1.15 * exp01 + 0.5;
                exp01 = round(exp01);
