...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    if(e1 >= 0 and e1 <= 3)
    {
        ...
        int D = (double)e1*3 + (double)exp1*7;
        if (D % 2 == 0)
        {
    ...
    //Case 4.1.2
    else if(e1 >= 4 and e1 <= 19)//info 1
    {
        exp2 = ceil( (double)exp2 + ( (double)e1 /4 + 19) );
        exp1 = exp1 - e1;
        
    }
    else if(e1 >= 20 and e1 <= 49)//info 2
    {
        exp2 = ceil( (double)exp2 + ( (double)e1 /9 + 21) );
        exp1 = exp1 - e1;
    }
    else if(e1 >= 50 and e1 <= 65)//info 3
    {
        exp2 = ceil( (double)exp2 + ( (double)e1 /16 + 17) );
        exp1 = exp1 - e1;
    }
    else if(e1 >= 66 and e1 <= 79)//info 1+2
    {
        exp2 = ceil( (double)exp2 + ( (double)e1 /4 + 19) );
        if(exp2 > 200)
        {
    ...
    else if(e1 >= 80 and e1 <= 99)//info 1+2+3
    {
        exp2 = ceil( (double)exp2 + ( (double)e1 /4 + 19) );
        exp2 = ceil( (double)exp2 + ( (double)e1 /9 + 21) );
        if(exp2 > 400)
...
// TODO: Complete this function
    ...
    //Road 1
        ...
        {
            P1 = ( (double)EXP1 / (double)S1 + 80)/123;
        }
    //Road 2
        int total_cost = 0;
    ...
    else 
    {
        ...
        if (P_avg < 0.5)
        {
            ...
            EXP1 = (double)EXP1 * 1.15;
        }
        else
        {
            HP1 = ceil( (double)HP1 * 0.9);
            EXP1 = (double)EXP1 * 1.2;
        }
    }
...
// TODO: Complete this function
    ...
    //Calculate point for Sherlock and Watson at meet point
...
int findCorrectPassword(const char* arr_pwds[], int num_pwds) {
    ...
    for (int i = 0; i < num_pwds; ++i) {
        ...
        if (current_freq > max_freq or (current_freq == max_freq && current_length > max_length) )
        {
