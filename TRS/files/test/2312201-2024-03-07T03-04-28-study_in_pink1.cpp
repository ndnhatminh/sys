...
int firstMeet(int& EXP1, int& EXP2, int E1) {
    ...
    int D = E1 * 3 + EXP1 * 7; int o = ceil(D / 200);int y = ceil(D / 100);
    if (E1 >= 0 && E1 < 4) {
        if (D % 2 == 0) { EXP1 = EXP1 + o;rsvl(EXP1, 0, 600); }
        else { EXP1 = EXP1 - y;rsvl(EXP1, 0, 600); };
    }
    //2.
    if (E1 > 3 && E1 < 20) { EXP2 = EXP2 + ceil(E1 * 1.000 / 4) + 19;rsvl(EXP2, 0, 600); }
    else if ((E1 > 19) && (E1 < 50)) {
    ...
    if (E1 > 3 && E1 < 100) { EXP1 = EXP1 - E1;rsvl(EXP1, 0, 600); }
    return EXP1 + EXP2;
    ...
    do {
        ...
        if (E2 % 2 != 0) {
            while (M1 > u) {
                ...
                if (M1 > u) { if (EXP1 < 400) { M1 = M1 - 200; } else { M1 = M1 - 120; } EXP1 = ceil(EXP1 * 1.13); rsvl(EXP1, 0, 600); }
                else break;
                if (M1 > u) { if (EXP1 < 300) { M1 = M1 - 100; } else { M1 = M1 - 120; } EXP1 = ceil(EXP1 * 0.9); rsvl(EXP1, 0, 600); }
                else break;
            }
            ...
            for (int i = 0;i < 1;i++) {
                ...
                if (M1 > 0) { if (EXP1 < 400) { M1 = M1 - 200;rsvl(M1, 0, 3000); } else { M1 = M1 - 120;rsvl(M1, 0, 3000); } EXP1 = ceil(EXP1 * 1.13); rsvl(EXP1, 0, 600); }
                else { M1 = 0;break; }
                if (M1 > 0) { if (EXP1 < 300) { M1 = M1 - 100;rsvl(M1, 0, 3000); } else { M1 = M1 - 120;rsvl(M1, 0, 3000); } EXP1 = ceil(EXP1 * 0.9); rsvl(EXP1, 0, 600); }
                else { M1 = 0;break; }
            }
            HP1 = ceil(HP1 * 0.83); EXP1 = ceil(EXP1 * 1.17);rsvl(EXP1, 0, 600);
        }
