...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    if (e1 >= 0 && e1 <= 3)
    {
        ...
        if (d % 2 == 0)
        {
            exp1 = round_up(exp1 + (float)d / 200);  /* Always round up, not round off */
        }
        else
        {
            exp1 = round_up(exp1 - (float)d / 100);
        }
    ...
    else if (e1 >= 4 && e1 <= 99)
    {
        if (e1 >= 4 && e1 <= 19)
        {
            exp2 = round_up(exp2 + (float)e1 / 4 + 19);
        }
        else if (e1 >= 20 && e1 <= 49)
        {
            exp2 = round_up(exp2 + (float)e1 / 9 + 21);
        }
        else if (e1 >= 50 && e1 <= 65)
        {
            exp2 = round_up(exp2 + (float)e1 / 16 + 17);
        }
        else if (e1 >= 66 && e1 <= 79)
        {
            exp2 = round_up(exp2 + (float)e1 / 4 + 19);
        ...
        else
        {
            exp2 = round_up(exp2 + (float)e1 / 4 + 19);
            check_mission1(exp1, exp2);
            exp2 = round_up(exp2 + (float)e1 / 9 + 21);     /* Round up first, check later, then compare with if () */
            check_mission1(exp1, exp2);
            if (exp2 > 400)
            {
                exp2 = round_up(exp2 + (float)e1 / 16 + 17);
