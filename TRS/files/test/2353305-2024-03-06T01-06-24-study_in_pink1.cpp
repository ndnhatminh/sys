...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    if(EXP1>=CP) P=100;
    else P=(((float)(EXP1/CP) +80)/123)*100;
    ...
    do
    {
        ...
        else
        {
            ...
            xu_li_HP(HP1);
            xu_li_M(M1);
            if((E2%2==1&&(M1*0.5)<=chi1)||M1==0) {break;};
        ...
        xu_li_HP(HP1);
        xu_li_M(M1);
        if((E2%2==1&&(M1*0.5)<=chi1)||M1==0) {EXP1 = ceil(EXP1*1.13);break;}; 
        ...
        else 
        {
         ...
         if((E2%2==1&&(M1*0.5)<=chi1)||M1==0) {EXP1 = ceil(EXP1*0.9);break;}
    }
    ...
    if(EXP1>=CP) P2=100;
    else P2=(((float)(EXP1/CP) +80)/123)*100;
