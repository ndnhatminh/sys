...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    if (E2 >= 0 && E2 <= 99) {
        ...
        if (E2 % 2 == 1) {
        ...
        else {// e2 = 60, hp1= 287 , exp1 = 472, m1= 2684
            if (M1 > 0) {
                if (HP1 < 200) {
            ...
            if (M1 > 0) {
                ...
                EXP1 = ceil((double)EXP1 * 1.13);//534
            ...
            if (M1 > 0) {
                ...
                EXP1 = ceil((double)EXP1 * 0.9);//481
            } 
            EXP1 = ceil((double)EXP1 * 1.17);//563
            HP1 = ceil((double)HP1 * 0.83);//263
        }
        limitM(M1);
        limitExp(EXP1);
        limitHp(HP1);
