...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    if (E2%2==0) {
        if (M1>0){if (HP1<200) {HP1=ceil(HP1*1.3 - 1.1920929e-07);
                    M1-=150;}
        else {HP1=ceil(HP1*1.1 - 1.1920929e-07);
            M1-=70;}
        if (M1<0) M1=0; if (M1>3000) M1=3000;
        if (HP1<0) HP1=0; if (HP1>666) HP1=666;
        if (EXP1<0) EXP1=0; if (EXP1>600) EXP1=600;}
        ...
        EXP1=ceil(EXP1*1.13 - 1.1920929e-07);
        if (M1<0) M1=0; if (M1>3000) M1=3000;
        if (HP1<0) HP1=0; if (HP1>666) HP1=666;
        if (EXP1<0) EXP1=0; if (EXP1>600) EXP1=600;}
        if (M1>0) {
        ...
        EXP1=ceil(EXP1*0.9 + 1.1920929e-07);
        if (M1<0) M1=0; if (M1>3000) M1=3000;
        if (HP1<0) HP1=0; if (HP1>666) HP1=666;
        if (EXP1<0) EXP1=0; if (EXP1>600) EXP1=600;}
        HP1=ceil(HP1*0.83 + 1.1920929e-07);
        EXP1=ceil(EXP1*1.17 - 1.1920929e-07);
        if (M1<0) M1=0; if (M1>3000) M1=3000;
        if (HP1<0) HP1=0; if (HP1>666) HP1=666;
        if (EXP1<0) EXP1=0; if (EXP1>600) EXP1=600;}
    if (E2%2==1)
    {
        while (M1>=m11)
        {
            if (M1>=m11) {if (HP1<200) {HP1=ceil(HP1*1.3 - 1.1920929e-07);
                  M1-=150;}
            else {HP1=ceil(HP1*1.1 - 1.1920929e-07);
                  M1-=70;}
            if (M1<0) M1=0; if (M1>3000) M1=3000;
    ...
    P3=P[i]/100.0;}
    if ((P1==1) && (P2==1) && (P3==1)) {EXP1=ceil(EXP1*0.75 + 1.1920929e-07);
    if (EXP1<0) EXP1=0; if (EXP1>600) EXP1=600;}
    else {Pall=(P1+P2+P3)/3.0;
    if (Pall<0.5) {HP1=ceil(HP1*0.85 + 1.1920929e-07); EXP1=ceil(EXP1*1.15 - 1.1920929e-07);}
    else {HP1=ceil(HP1*0.9 + 1.1920929e-07); EXP1=ceil(EXP1*1.2 - 1.1920929e-07);}
    if (M1<0) M1=0; if (M1>3000) M1=3000;
    if (HP1<0) HP1=0; if (HP1>666) HP1=666;
    if (EXP1<0) EXP1=0; if (EXP1>600) EXP1=600;}
    return HP1 + EXP1 + M1;
...
int chaseTaxi(int & HP1, int & EXP1, int & HP2, int & EXP2, int E3) {
    ...
    if (abs(score_taxi) > abs(score)) {
        EXP1=ceil(EXP1*0.88 + 1.1920929e-07);
        EXP2=ceil(EXP2*0.88 + 1.1920929e-07);
        HP1=ceil(HP1*0.9 + 1.1920929e-07);
        HP2=ceil(HP2*0.9 + 1.1920929e-07);
        if (EXP1 < 0) EXP1 = 0; if (EXP1 > 600) EXP1 = 600;
        if (HP1 < 0) HP1 = 0;   if (HP1 > 666) HP1 = 666;
        if (EXP2 < 0) EXP2 = 0;   if (EXP2 > 600) EXP2 = 600;
        if (HP2 < 0) HP2 = 0;    if (HP2 > 666) HP2 = 666;
        ...
        EXP1=ceil(EXP1*1.12- 1.1920929e-07);
        EXP2=ceil(EXP2*1.12- 1.1920929e-07);
        HP1=ceil(HP1*1.1- 1.1920929e-07);
        HP2=ceil(HP2*1.1- 1.1920929e-07);
        if (EXP1 < 0) EXP1 = 0; if (EXP1 > 600) EXP1 = 600;
        if (HP1 < 0) HP1 = 0;   if (HP1 > 666) HP1 = 666;
        if (EXP2 < 0) EXP2 = 0;   if (EXP2 > 600) EXP2 = 600;
        if (HP2 < 0) HP2 = 0;    if (HP2 > 666) HP2 = 666;
