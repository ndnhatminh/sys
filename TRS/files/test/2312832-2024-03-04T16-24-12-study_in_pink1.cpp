...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    if (E2 % 2 == 0) {
        if (M1 > 0) {
            ...
            if (M1 > 0) {
                ...
                if (EXP1 % 10 == 0)EXP1 = EXP1 - EXP1 * 0.1;
                else EXP1 = EXP1 - ceil(EXP1 * 0.1) + 1;
            }
        }
        if (EXP1 % 100 == 0) {
            EXP1 = EXP1 * 1.17;
    ...
    if (P1 == P2 == P3 == 1) {
        if (EXP1 % 4 == 0) EXP1 = EXP1 - EXP1 / 4;
        else EXP1 = EXP1 - ceil(EXP1 / 4.0) + 1;
    }
    else {
        P = (P1 + P2 + P3) / 3;
        if (P < 0.5) {
...
int checkPassword(const char* s, const char* email) {
    ...
    for (int i = 0; i < pwds.length(); i++) {
        if (pwds[i] == pwds[i + 1] == pwds[i + 2]) return (-(400 + i));
    }
