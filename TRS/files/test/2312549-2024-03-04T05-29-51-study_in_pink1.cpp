...
float xacsuatconduong2chan(int EXP1, int HP1, int M1) {
    if (HP1 < 200) {
        HP1 = ceil((float)HP1 * 1.3);  M1 = M1 - 150; M1 = checkM(M1);
    }
    else {
        HP1 = ceil((float)HP1 * 1.3); M1 = M1 - 70; M1 = checkM(M1);
    }
    //====== hanh dong 2 ======//
    if (EXP1 < 400 && M1>0) {
        EXP1 = ceil((float)EXP1 * 1.13); M1 = M1 - 200; M1 = checkM(M1);
    }
    if (EXP1 >= 400 && M1 > 0) {
        EXP1 = ceil((float)EXP1 * 1.13); M1 = M1 - 120; M1 = checkM(M1);
    }

    //====== hanh dong 3=======//
    if (EXP1 < 300 && M1>0) {
        EXP1 = ceil((float)EXP1 * 0.9); M1 = M1 - 100; M1 = checkM(M1);
    }
    if (EXP1 >= 300 && M1 > 0) {
        EXP1 = ceil((float)EXP1 * 0.9); M1 = M1 - 120; M1 = checkM(M1);
    }
    if (M1 == 0) {
        HP1 = ceil((float)HP1 * 0.83);
        EXP1 = ceil((float)EXP1 * 1.17);
...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E3) {
    ...
    if (E3 % 2 == 0) {
        if (HP1 < 200) {
            ...
            HP1 = ceil((float)HP1 * 1.1); M1 = M1 - 70; M1 = checkM(M1);
        }
        //====== hanh dong 2 ======//
        if (EXP1 < 400 && M1>0) {
            EXP1 = ceil((float)EXP1 * 1.13); M1 = M1 - 200; M1 = checkM(M1);
...
int checkPassword(const char* s, const char* email) {
    ...
    for (int i = 0; i < lens; i++) {
        if (s[i]!= '@' && s[i] != '#' && s[i] != '$' && s[i] != '%' && s[i] != '!')  return -5;
    }
    for (int i = 0; i < lens; i++) {
