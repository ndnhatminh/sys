...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    if (e1 >= 0 && e1 <= 3) {
        ...
        int D = e1 * 3 + exp1 * 7;
        if (D % 2 == 0) exp1 = checkExp(ceil(exp1 + D / 200.0));
        else exp1 = checkExp(ceil(exp1 - D / 100.0));
    }
    else if (e1 >= 4 && e1 <= 99) {
        if (e1 < 20) exp2 = checkExp(ceil(exp2 + e1 / 4.0 + 19));
        else if (e1 < 50) exp2 = checkExp(ceil(exp2 + e1 / 9.0 + 21));
            else if (e1 < 66) exp2 = checkExp(ceil(exp2 + e1 / 16.0 + 17));
                else if (e1 < 80) {
                    exp2 = checkExp(ceil(exp2 + e1 / 4.0 + 19));
                    if (exp2 > 200) exp2 = checkExp(ceil(exp2 + e1 / 9.0 + 21));
                }
                    else {
                        exp2 = checkExp(ceil(exp2 + e1 / 4.0 + 19));
                        exp2 = checkExp(ceil(exp2 + e1 / 9.0 + 21));
                        if (exp2 > 400) {
                            exp2 = checkExp(ceil(exp2 + e1 / 16.0 + 17));
                            exp2 = checkExp(ceil(exp2 * 1.15));
                        }
                    }
    }
