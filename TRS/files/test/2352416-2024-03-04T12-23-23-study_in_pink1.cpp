...
conditionT2(HP1,EXP1,M1);
int deHP1=HP1,deEXP1=EXP1,deM1=M1;int perfect=0;
if(M1==0) {       
    float iHP1=HP1*(1-0.17);
    HP1= ceil(iHP1);
    float iEXP1=EXP1*1.17;
...
while (true)
{
HP1=deHP1,EXP1=deEXP1,M1=deM1;
if(perfect==1)
{
float iEXP1=deEXP1*0.75;
EXP1= ceil(iEXP1);
conditionT2(HP1,EXP1,M1);
}
float P1,P2,P3;
...
if(P1==1&&P2==1&&P3==1)   // wrong case - do again
{
float iEXP1=EXP1*0.75;
EXP1= ceil(iEXP1); perfect=1;
conditionT2(HP1,EXP1,M1);
}
else
{   
