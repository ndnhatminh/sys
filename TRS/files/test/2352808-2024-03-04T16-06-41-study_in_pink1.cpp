...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    while (E2 % 2 == 1 && M1 > nua)
    {
        //event 1
        if (HP1 < 200) {
            HP1 += std::ceil((double)HP1 * 0.3);
            M1 -= 150;
        }
        else {
            HP1 += std::ceil((double)HP1 * 0.1);
            M1 -= 70;
        }
        EXP1 = (EXP1 > 600) ? 600 : (EXP1 < 0) ? 0 : EXP1;
        HP1 = (HP1 > 666) ? 666 : (HP1 < 0) ? 0 : HP1;
        ...
        if (EXP1 < 400) {
            M1 -= 200;
            EXP1 += std::ceil((double)EXP1 * 0.13);
        }
        else {
            M1 -= 120;
            EXP1 += std::ceil((double)EXP1 * 0.13);
        ...
        if (EXP1 < 300) {
            M1 -= 100;
            EXP1 -= std::floor((double)EXP1 * 0.1);
        }
        else {
            M1 -= 120;
            EXP1 -= std::floor((double)EXP1 * 0.1);
    ...
    HP1 -= std::floor((double)HP1 * 0.17);
    EXP1 += std::ceil((double)EXP1 * 0.17);
    ...
    if (E2 % 2 == 0) {
        ...
        if (EXP1 < 400) {
            M1 -= 200;
            EXP1 += std::floor((double)EXP1 * 0.13);
        }
        else {
            M1 -= 120;
            EXP1 += std::floor((double)EXP1 * 0.13);
    ...
    if (XS_P1 == 1 && XS_P2 == 1 && XS_P3 == 1)
        ...
        EXP1 += floor((double)EXP1 * 0.15);
        HP1 -= floor((double)HP1 * 0.15);
    }
    else if (total_P >= 0.5) {
        HP1 = ceil(HP1 * 0.9);
        EXP1 += floor((double)EXP1 * 0.2);
    }
    EXP1 = (EXP1 > 600) ? 600 : (EXP1 < 0) ? 0 : EXP1;
    HP1 = (HP1 > 666) ? 666 : (HP1 < 0) ? 0 : HP1;
    M1 = (M1 > 3000) ? 3000 : (M1 < 0) ? 0 : M1;
