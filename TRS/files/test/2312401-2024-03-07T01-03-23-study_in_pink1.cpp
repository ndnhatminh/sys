...
int chaseTaxi(int & HP1, int & EXP1, int & HP2, int & EXP2, int E3) {
    ...
    {
        EXP1 = cceil(EXP1*1.12);resetexp(EXP1);
        EXP2 = cceil(EXP2*1.12);resetexp(EXP2);
        HP1 = cceil(HP1*1.1);resethp(HP1);
        HP2 = cceil(HP2*1.1);resethp(HP2);
        return dmax[a][b];
    }
    else
    {
        EXP1 = cceil(EXP1*0.88);resetexp(EXP1);
        EXP2 = cceil(EXP2*0.88);resetexp(EXP2);
        HP1 = cceil(HP1*0.9);resethp(HP1);
        HP2 = cceil(HP2*0.9);resethp(HP2);
        return m[a][b];
    }
}
// Task 4
