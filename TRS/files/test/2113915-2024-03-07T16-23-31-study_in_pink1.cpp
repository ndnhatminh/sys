...
int firstMeet(int & EXP1, int & EXP2, int E1) {
  ...
  if ((E1 < 0 ) || (E1 > 99)) return -99;
    ...
    //UPDATE WATSON EXP;
	  if ((E1 >= 4) && (E1 <= 19)) EXP2 = ceil(EXP2 + 1.0*D1);
		 else if ((E1 >= 20) && (E1 <= 49)) EXP2 = ceil(EXP2 + 1.0*D2);
		 else if ((E1 >= 50) && (E1 <= 65)) EXP2 = ceil(EXP2 + 1.0*D3);
		 else if ((E1 >= 66) && (E1 <= 79)){
		 	      EXP2 = ceil(EXP2 + 1.0*D1 );
		 	      if (EXP2 > 200){
		 	      	  EXP2 = ceil(EXP2 + 1.0*D2);
				   }
		 }
		 else if ((E1 >= 80) && (E1 <= 99)){
		 	      EXP2 = ceil(EXP2 + 1.0*D1);
