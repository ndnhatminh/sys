...
int chaseTaxi(int & HP1, int & EXP1, int & HP2, int & EXP2, int E3) 
{
    ...
    if (abs(road[x][y]) > max) 
    {
        EXP1-=(int)((double)EXP1*12/100);
        EXP1=check_variable(EXP1, 1);
        HP1-=(int)((double)HP1*10/100);
        HP1=check_variable(HP1, 0);
        EXP2-=(int)((double)EXP2*12/100);
        EXP2=check_variable(EXP2,1);
        HP2-=(int)((double)HP2*10/100);
        HP2=check_variable(HP2,0);
        return road[x][y];
    }
    else
    {
        EXP1+=up_round((double)EXP1*12/100);
        EXP1=check_variable(EXP1, 1);
        HP1+=up_round((double)HP1*10/100);
        HP1=check_variable(HP1, 0);
        EXP2+=up_round((double)EXP2*12/100);
        EXP2=check_variable(EXP2,1);
        HP2+=up_round((double)HP2*10/100);
        HP2=check_variable(HP2,0);
        return max;
