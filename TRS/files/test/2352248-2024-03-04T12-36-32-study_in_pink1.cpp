...
int S = closestsquarenumber(EXP1);
   double P1;
    ...
    if (HP1 < 200)
    {
        HP1 = ceil(1.0*( HP1 + 0.3*HP1));
        M1 -= 150;
        setthelimit(HP1, EXP1, M1);
        totalmoneyspent += 150;
    } else if (HP1 >= 200)
    {
        HP1 = ceil(1.0*(HP1 + 0.1*HP1));
        M1 -= 70;
        setthelimit(HP1, EXP1, M1);
        totalmoneyspent += 70;
    } if(totalmoneyspent > half_of_money )
    {
        break;
    }
    if (EXP1 < 400)
    ...
    EXP1 = ceil(1.0*(EXP1 + (13.0/100*EXP1)));
    setthelimit(HP1, EXP1, M1);
    if (EXP1 < 300)
    {
        M1 -= 100;
    ...
    EXP1 = ceil(1.0*(EXP1 - (10.0/100)*EXP1));
    setthelimit(HP1, EXP1, M1);
    } 
    ...
    HP1 = ceil(1.0*(HP1 - (17.0/100)*HP1));
    EXP1 = ceil(1.0*(EXP1 + (17.0/100)*EXP1));
    setthelimit(HP1, EXP1, M1);
    ...
    if (totalP < 0.5)
    {
        HP1 = ceil(1.0*(HP1 - (15.0/100)*HP1));
        EXP1 = ceil(1.0*(EXP1 + EXP1*(15.0/100)));
        setthelimit(HP1, EXP1, M1);
    } else if (totalP >= 0.5)
    {
        HP1 = ceil(1.0*(HP1 - HP1*(10.0/100)));
        EXP1 = ceil(1.0*(EXP1 + EXP1*(20.0/100)));
        setthelimit(HP1, EXP1, M1);
    }
