...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    if (E2%2 !=0){
        ...
        if (M1){if (EXP1<400){M1=M1-200;} else {M1=M1-120;} EXP1=ceil(EXP1*1.13); rsvl(EXP1,0,600);} else break;
        if (M1){if (EXP1<300){M1=M1-100;} else {M1=M1-120;} EXP1=ceil(EXP1*0.9); rsvl(EXP1,0,600);} else break;
        }
          HP1=ceil(HP1*0.83); EXP1=ceil(EXP1*1.17);
    }
  double p2;
