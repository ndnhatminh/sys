...
int ceili(double x)
{
    double intp, fracp;
    fracp = modf(x, &intp);
    if ((fracp >= 0.5) || (fracp <= -0.5) || (abs(fracp) > 1e-10)) return ceil(x); else return x;
}
...
int firstMeet(int& exp1, int& exp2, int e1) {
    ...
    if ((e1 < 0) || (e1 > 99)) return -99; else
    {
        ...
        if ((e1 >= 0) && (e1 <= 3))//case1
        {
            ...
            if ((e1 >= 4) && (e1 <= 99))//case2
            {
                if ((e1 >= 4) && (e1 <= 19)) exp2 += ceili(e1 / 4.0) + 19; else
                    if ((e1 >= 20) && (e1 <= 49)) exp2 += ceili(e1 / 9.0) + 21; else
                        if ((e1 >= 50) && (e1 <= 65)) exp2 += ceili(e1 / 16.0) + 17; else
                            if ((e1 >= 66) && (e1 <= 79))
                            {
                                exp2 += ceili(e1 / 4.0) + 19;
                                if (exp2 > 200) exp2 += ceili(e1 / 9.0) + 21;
                            }
                            else
                                if ((e1 >= 80) && (e1 <= 99))
                                {
                                    exp2 += ceili(e1 / 4.0) + 19 + ceili(e1 / 9.0) + 21;
                                    if (exp2 > 400)
                                    {
                                        exp2 += ceili(e1 / 16.0) + 17;
                                        exp2 = ceili(exp2 * 1.15);
                                    }
                                }
                if (exp2 > 600) exp2 = 600;
                exp1 -= e1;
...
void action1(int& HP1, int& EXP1, int& M1)
{
    if (HP1 < 200) {
        HP1 = ceili(HP1 * 1.3);
        M1 -= 150;
...
void action2(int& HP1, int& EXP1, int& M1)
{
    if (EXP1 < 400) M1 -= 200; else M1 -= 120;
    EXP1 = ceili(EXP1 * 1.13);
    if (EXP1 > 600) EXP1 = 600;
    if (M1 < 0) M1 = 0;
}
void action3(int& HP1, int& EXP1, int& M1)
{   
...
int traceLuggage(int& HP1, int& EXP1, int& M1, int E2) {
    ...
    if ((E2 < 0) || (E2 > 99)) return -99; else
    {
        ...
        if (EXP1 >= S) p1 = 100; else p1 = ceili((EXP1 / S + 80) / 123.0 * 100);
        //road2
        double temp = M1 * 0.5;
        if (E2 % 2 == 0) 
        {
            if (M1 > 0) action1(HP1, EXP1, M1);
            if (M1 > 0) action2(HP1, EXP1, M1);
            if (M1 > 0) action3(HP1, EXP1, M1);
        }
        else 
            while (1)
            {
                if (M1 >= temp) action1(HP1, EXP1, M1); else break;
                if (M1 >= temp) action2(HP1, EXP1, M1); else break;
                if (M1 >= temp) action3(HP1, EXP1, M1); else break;
            }
        HP1 = ceili(HP1 * 0.83);
        EXP1 = ceili(EXP1 * 1.17);
        if (EXP1 > 600) EXP1 = 600;
        S = nearestSquare(EXP1);
        if (EXP1 >= S) p2 = 100; else p2 = ceili((EXP1 / S + 80) / 123.0 * 100);
        //road3
        int p[10] = { 32, 47, 28, 79, 100, 50, 22, 83, 64, 11 };
        if (E2 < 10) p3 = p[E2]; else p3 = p[(E2 % 10 + E2 / 10) % 10];
        if (p1 == 100 && p2 == 100 && p3 == 100) EXP1 = ceili(EXP1 * 0.75);
        else
        {
            int P = ceili((p1 + p2 + p3) / 3.0);
            if (P < 50) {
                EXP1 = ceili(EXP1 * 1.15);
                if (EXP1 > 600) EXP1 = 600;
                HP1 = ceili(HP1 * 0.85);
            }
            else {
...
int chaseTaxi(int& HP1, int& EXP1, int& HP2, int& EXP2, int E3) {
    ...
    if ((E3 < 0) || (E3 > 99)) return -99; else
    {
        ...
        {
            result = abs(max);
            EXP1 = ceili(EXP1 * 1.12);
            HP1 = ceili(HP1 * 1.1);
            EXP2 = ceili(EXP2 * 1.12);
            HP2 = ceili(HP2 * 1.1);
            if (EXP1 > 600) EXP1 = 600;
            if (HP1 > 666) HP1 = 666;
            if (EXP2 > 600) EXP2 = 600;
        ...
        {
            result = sc[x][y];
            EXP1 = ceili(EXP1 * 0.88);
            HP1 = ceili(HP1 * 0.9);
            EXP2 = ceili(EXP2 * 0.88);
            HP2 = ceili(HP2 * 0.9);
        }
        return result;
    }
