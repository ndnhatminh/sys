    ...
    if( E2%2 != 0){
        ...
        while(true){
            ...
            if(HP1 < 200) 
            {
                ...
                else {M1 = 0; HP1 = ceil(double(HP1)*13/10);if(EXP1 > 600) EXP1 = 600;if(EXP1 < 0) EXP1 = 0;  if(HP1 > 666) HP1 = 666;if(HP1 < 0) HP1 = 0; if(M1 > 3000) M1 = 3000;if(M1 < 0) M1 = 0; break; }
            }
            else 
            {
                if(M1>70) {M1 -= 70; HP1 = ceil(double(HP1)*11/10); m+= 70;}
                else {M1 = 0; HP1 = ceil(double(HP1)*11/10);if(EXP1 > 600) EXP1 = 600;if(EXP1 < 0) EXP1 = 0;  if(HP1 > 666) HP1 = 666;if(HP1 < 0) HP1 = 0; if(M1 > 3000) M1 = 3000;if(M1 < 0) M1 = 0; break; }
            }
            if(EXP1 > 600) EXP1 = 600;
            if(EXP1 < 0) EXP1 = 0; 
            if(HP1 > 666) HP1 = 666;
            ...
            if(EXP1 < 400)
            {
                ...
                else {M1 = 0; EXP1 = ceil(double(EXP1)*11.3/10);if(EXP1 > 600) EXP1 = 600;if(EXP1 < 0) EXP1 = 0;  if(HP1 > 666) HP1 = 666;if(HP1 < 0) HP1 = 0; if(M1 > 3000) M1 = 3000;if(M1 < 0) M1 = 0; break; }
            }
            else 
            {
            ...
            if(EXP1 <300)
            {
                ...
                else {M1 = 0; EXP1 = ceil(double(EXP1)*9/10);if(EXP1 > 600) EXP1 = 600;if(EXP1 < 0) EXP1 = 0;  if(HP1 > 666) HP1 = 666;if(HP1 < 0) HP1 = 0; if(M1 > 3000) M1 = 3000;if(M1 < 0) M1 = 0; break;}
            }
            else
            {
