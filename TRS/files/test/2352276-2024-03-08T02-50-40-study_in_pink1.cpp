...
// Tăng giảm HP và EXP
if (batDuoc) {
        HP1 = min(666, int(ceil(HP1 * 1.10)));
        HP2 = min(666, int(ceil(HP2 * 1.10)));
        EXP1 = min(600, int(ceil(EXP1 * 1.12)));
        EXP2 = min(600, int(ceil(EXP2 * 1.12)));
    } else {
        HP1 = max(0, int(ceil(HP1 * 0.90)));
        HP2 = max(0, int(ceil(HP2 * 0.90)));
        EXP1 = max(0, int(ceil(EXP1 * 0.88)));
        EXP2 = max(0, int(ceil(EXP2 * 0.88)));
    }
