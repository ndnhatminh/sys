...
int firstMeet(int & exp1, int & exp2, int e1) {
    ...
    if ((e1>=0)&&(e1<=3))
    {
        ...
        if (D%2==0)
        {
            exp1=ceil_1(exp1+D/200,D%200);
            exp1=CheckEXP(exp1);
        }
        else
        {
            exp1=ceil_1(exp1-D/100,D%100);
            exp1=CheckEXP(exp1);
        }
    }
    else if ((e1>=4)&&(e1<=99))
    {
        if ((e1<=19)&&(e1>=4))
        {
            exp2=ceil_1(exp2 + e1/4 + 19 ,e1%4);
            exp2=CheckEXP(exp2);
        }
        else if ((e1>=20)&&(e1<=49))
        {
            exp2=ceil_1(exp2 + e1/9 + 21,e1%9 );
            exp2=CheckEXP(exp2);
        }
        else if ((e1>=50)&&(e1<=65))
        {
            exp2=ceil_1(exp2 + e1/16 + 17 ,e1%16);
            exp2=CheckEXP(exp2);
        }
        else if ((e1>=66)&&(e1<=79))
        {
...
int traceLuggage(int & HP1, int & EXP1, int & M1, int E2) {
    ...
    if (E2 % 2 == 0)
  {
	while (true)
	  {
		if (HP1 < 200)
		  {
			HP1 = ceil ((float) CheckHP ((float) HP1 * 1.3));
			M1 = M1 - 150;
			M1 = CheckMoney (M1);
		  }
		else
		  {
			HP1 = ceil ((float) CheckHP ((float) HP1 * 1.1));
			M1 = M1 - 70;
			M1 = CheckMoney (M1);
		  }
		if (M1 == 0)
		...
		if (EXP1 < 400)
		  {
			M1 -= 200;
			EXP1 = ceil ((float) CheckEXP ((float) EXP1 * 1.13));
			M1 = CheckMoney (M1);
		  }
		else
		  {
		...
		if (EXP1 < 300)
		  {
			EXP1 = ceil ((float) CheckEXP (EXP1 * 0.9));
			M1 -= 100;
			M1 = CheckMoney (M1);
		  }
		else
...
else
    {
        while (true)
        {
            ...
            if (EXP1 < 300)
            {
                ...
                EXP1 = ceil ((float) CheckEXP ((float) EXP1 * 0.9));
                M1 -= 100;
                M1 = CheckMoney (M1);
                pay+=100;
            }
    ...
    else
    {
        ...
        if (ptb <0.5)
        {
            HP1=ceil(CheckHP((float)HP1*0.85));
            EXP1=ceil(CheckEXP((float)EXP1*1.15));
        }
        else
        {
            HP1=ceil(CheckHP((float)HP1*0.9));
            EXP1 =ceil(CheckEXP((float)EXP1*1.2));
        }
    }
